...
public class ManagerController {
	...
	public ModelAndView managerasklist(@RequestParam(name = "page", defaultValue = "1") int page,
	...
	public ModelAndView managercslist(@RequestParam(name = "page", defaultValue = "1") int page,
			@RequestParam(name = "size", defaultValue = "10") int size,
			@RequestParam(name = "type", required = false) String type) {
	...
	public ModelAndView managernoticelist(@RequestParam(name = "page", defaultValue = "1") int page,
			@RequestParam(name = "size", defaultValue = "10") int size,
			@RequestParam(name = "type", required = false) String type) {
	...
	public ModelAndView manageralbumlist(@RequestParam(name = "page", defaultValue = "1") int page,
			@RequestParam(name = "size", defaultValue = "10") int size,
			@RequestParam(name = "type", required = false) String type) {
		if (page < 1)
			page = 1;
	...
	// 관리자 상품등록 화면
	@RequestMapping("/ProductRegistrationForm")
	public ModelAndView productRegistrationForm() {
		ModelAndView mv = new ModelAndView();
		List<HashMap<String, Object>> categoryList = managerService.getCategoryList();
		mv.addObject("categoryList", categoryList);
		mv.setViewName("manager/managerProductRegistrationForm");
		return mv;
	}

	// 관리자 상품등록 화면
	@RequestMapping("/ProductRegistration")
	public ModelAndView productRegistration(@RequestParam HashMap<String, Object> map,
			@RequestParam(value = "profileImge") MultipartFile[] profileImge) {
		ModelAndView mv = new ModelAndView();
		System.out.println(map);
		managerService.saveProduct(map,profileImge);
		mv.setViewName("redirect:/Manager/ProductRegistrationForm");
		return mv;
	}
