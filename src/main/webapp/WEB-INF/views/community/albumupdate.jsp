...
<div class="inner">  
    ...
    <div style="width: 790px;">
      ...
      <div class="writeform">
      <form action="/Community/Albumupdate?community_idx=${community_idx}"  method="POST" enctype="multipart/form-data">
        <div><input class="title" type="text" name="community_title" id="community_title" value="${vo.community_title}"/></div>
        <input type="hidden" name="community_menu"  value="조립앨범"/>
        <!-- 구분선 추가 -->
        <div><hr style="border: 1px solid #ddd; margin-bottom:20px;"></div>
        
        <div>
        <textarea name="community_content" id="editor" >${vo.community_content}</textarea>
        </div>
        ...
        <div style="margin-top:10px;">
		  ...
		  <img id="preview" src="/images/${vo.community_sfile_name}" alt="대표 이미지 미리보기" style="margin-top:10px; max-width:100px;">
        </div>
        ...
        <div>
          <table>
            <tr>
              <th>CPU</th>
              <td>
                <input type="text" name="community_spec_cpu" id="cpuSearch" value="${vo.community_spec_cpu}">
            ...
            <tr>
              <th>메인보드</th>
              <td>
                <input type="text" name="community_spec_mainboard" id="mainboardSearch" value="${vo.community_spec_mainboard}">
            ...
            <tr>
              <th>메모리</th>
              <td>
                <input type="text" name="community_spec_memory" id="memorySearch" value="${vo.community_spec_memory}">
            ...
            <tr>
              <th>그래픽카드</th>
              <td>
                <input type="text" name="community_spec_gpu" id="gpuSearch" value="${vo.community_spec_gpu}">
            ...
            <tr>
              <th>SSD</th>
              <td>
                <input type="text" name="community_spec_ssd" id="ssdSearch" value="${vo.community_spec_ssd}">
            ...
            <tr>
              <th>HDD</th>
              <td>
                <input type="text" name="community_spec_hdd" id="hddSearch" value="${vo.community_spec_hdd}">
            ...
            <tr>
              <th>CPU 쿨러</th>
              <td>
                <input type="text" name="community_spec_cooler" id="coolerSearch" value="${vo.community_spec_cooler}">
            ...
            <tr>
              <th>케이스</th>
              <td>
                <input type="text" name="community_spec_case" id="caseSearch" value="${vo.community_spec_case}">
            ...
            <tr>
              <th>파워</th>
              <td>
                <input type="text" name="community_spec_power" id="powerSearch" value="${vo.community_spec_power}">
			...
			<tr style="border: none; text-align: center; margin-top:30px;">
              <td colspan="2" >
      	        <input type="submit" value="수정완료" class="btn btn-light-gray" />
