...
<div class="inner">
  ...
  <div style="display: flex;">
      ...
      <table>
        <tr>
         ...
         <td class="mycs-content">
           ...
           <div class="content"><div><pre>${vo.customer_service_content}</pre></div></div><br><br><br>
    ...
    <div class="cs-nav">
      <table>
        <tr style="background-color: #ccc;"><td><a href="/Cs/Mycslist">문의내역 확인하기</a></td></tr>
        <tr><td><a href="#">아이디/비밀번호찾기</a></td></tr>
        <tr><td><a href="#">마이페이지</a></td></tr>
        <tr><td><a href="/Cs/CswriteForm">문의글 작성</a></td></tr>
