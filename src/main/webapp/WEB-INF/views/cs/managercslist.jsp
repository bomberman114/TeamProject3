...
<div class="inner" style="display: flex;">
    <div class="sidebar">
        <ul>
			...
			<li>                             
                <a href="/Cs/ManagerCsList" style="background-color: #CCC">문의내역</a>
        ...
        <table>
            ...
            <tbody>
                <c:forEach var="macsList" items="${macsList}">
                    <tr onclick="location.href='/Cs/ManagerAskUpdateForm?customer_service_idx=${macsList.customer_service_idx}'" style="cursor: pointer;">
                        <td>[${macsList.customer_service_type}]</td>
                        <td>${macsList.customer_service_title}</td>
                        <td>${macsList.customer_service_answer_status}</td>                        
