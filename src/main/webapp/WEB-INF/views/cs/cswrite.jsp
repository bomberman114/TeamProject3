...
<div class="inner">
  ...
  <div style="display: flex;">
    ...
    <div class="writeform">
    <form action="/Cs/Cswrite"  method="POST" enctype="multipart/form-data">
      <table>
        <tr>
          <th>문의제목</th>
        ...
        <tr>
          <th>회원정보</th>
          <td>이메일: 로그인 후 table.users에서 user_email 가지고 오기
        </tr>      
    ...
    <div class="cs-nav">
      <table>
        <tr><td><a href="/Cs/Mycslist">문의내역 확인하기</a></td></tr>
        <tr><td><a href="#">아이디/비밀번호찾기</a></td></tr>
        <tr><td><a href="#">마이페이지</a></td></tr>
        <tr style="background-color: #ccc;"><td><a href="/Cs/CswriteForm">문의글 작성</a></td></tr>
